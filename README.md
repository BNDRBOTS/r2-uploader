...
2. Log in to [Railway](https://railway.com?referralCode=jARGAL) and click **New Project → Deploy from GitHub repo**.
...
1. Go to [Railway](https://railway.com?referralCode=jARGAL) and log in.
